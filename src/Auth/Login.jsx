    ...
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
      ...
      <div className=" w-full md:w-1/2 flex items-center justify-center md:justify-start px-5 md:px-10 lg:px-15 py-10 md:py-0">
        ...
        />
          ...
          <h2 className="text-center text-[28px] mb-0 poppins font-semibold text-black ">Welcome back</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <label className="flex items-center justify-between w-full mt-2 space-x-2 text-sm">
              ...
              <span className="text-[#0B0A0A] text-base font-normal">
                ...
                <Link to="/forgot-password" className="text-[#009345] hover:underline">
          ...
          <p className="text-base font-normal pl-7 text-[#000000] mb-6">
            ...
            <Link to='/signup' className="text-[#009345] pl-2 hover:underline">Sign up</Link>
          </p>
          <div class="w-full mx-auto">          
              <div class="flex items-center my-6">
                <div class="flex-grow border-t border-gray-300"></div>
                <span class="mx-4 text-[#151417] font-normal text-sm">or sign in with your work email</span>
                <div class="flex-grow border-t border-gray-300"></div>
              </div>        
