      ...
      <div className="w-full md:w-1/2 flex items-center justify-center md:justify-start px-5 md:px-10 lg:px-15 py-10 md:py-0">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-2">
            ...
            <button
              type="submit"
              className="w-full bg-[#E0B654] hover:bg-amber-300 transition duration-300 ease-in-out transform hover:scale-105  mt-3 mb-2 text-white py-2 rounded cursor-pointer  "
            >
              Sign Up
            </button>
          </form>
          ...
          <p className="text-base font-normal text-[#000000] mb-6">
            ...
            <Link to="/login" className="text-[#009345] pl-2 hover:underline">
              Login
            </Link>
          </p>
        </div>
