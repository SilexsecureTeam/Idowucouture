          ...
          <div className="flex flex-col lg:flex-row gap-5 gap-x-5">
            ...
            <div className="flex-1 bg-white h-[385px] overflow-y-auto cartshadow px-4 py-1 rounded-xl">
              {cart.map((item, index) => (
                <div
                  ...
                  } flex border-b-gray-200 items-center gap-x-2 py-3`}
                >
                  <img
                    src={item.image}
                    alt={item.name}
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-black font-normal">
                      Size:{" "}
                      <span className="opacity-60">{item.size || "N/A"}</span>{" "}
                      <br />
                      Color:{" "}
                      <span className="opacity-60">{item.color || "N/A"}</span>
                    </div>
                    <div className="flex items-center justify-between w-full">
            ...
            <div className="w-full lg:min-w-1/3 lg:w-fit bg-white cartshadow rounded-xl p-6">
              ...
              <div className="flex justify-between py-1">
                <span className="text-[20px] opacity-60 font-medium">
                  Subtotal
                </span>
