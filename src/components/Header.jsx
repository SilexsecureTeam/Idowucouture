  ...
  return (
    <div className='flex px-5 sm:px-10 lg:px-20 items-center justify-between h-16 bg-white relative'>
      ...
      <ul className="hidden md:flex justify-between items-center w-full max-w-[330px]">
        ...
        <li className="text-[#6C7275] cursor-pointer font-medium">Product</li>
      ...
      {menuOpen && (
        <div className="absolute top-full left-0 w-full bg-white shadow-md z-50 md:hidden">
          <ul className="flex flex-col items-center py-4 space-y-2">
            <li className="cursor-pointer font-medium" onClick={() => setMenuOpen(false)}>Home</li>
            <li className="text-[#6C7275] cursor-pointer font-medium" onClick={() => setMenuOpen(false)}>Shop</li>
            <li className="text-[#6C7275] cursor-pointer font-medium" onClick={() => setMenuOpen(false)}>Product</li>
            <li className="text-[#6C7275] cursor-pointer font-medium" onClick={() => setMenuOpen(false)}>Contact Us</li>
          </ul>
        </div>
      )}
    </div>
