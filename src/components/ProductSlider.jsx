            ...
            <div className="bg-white rounded-lg shadow-sm pb-4 items-center relative group hover:shadow-lg transition">
              ...
              <div className="px-2 w-full">
                ...
                <div className="text-start w-full mt-2">
                  <div className="font-semibold w-full text-base">{selectedProduct?.name || product.name}</div>
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-2">
                      <span className="text-sm font-bold">₦{(selectedProduct?.price || product.price).toFixed(2)}</span>
